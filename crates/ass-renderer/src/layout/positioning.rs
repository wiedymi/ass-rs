...
impl PositionInfo {
    ...
    pub fn calculate(
        ...
        let (anchor_x, anchor_y) = Self::get_anchor_point(alignment, bbox, screen_width, screen_height, margin_left, margin_right, margin_vertical);
...
mod tests {
    ...
    fn test_alignment_positions() {
        ...
        let pos = PositionInfo::calculate(
            &tags,
            &bbox,
            1920.0,
            1080.0,
