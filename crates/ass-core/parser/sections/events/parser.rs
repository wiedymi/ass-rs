//! Streaming parse lifecycle for the `[Events]` section.
//!
//! Implements [`EventsParser`] construction, the top-level parse loop, format
//! line handling, and the whitespace/comment control helpers used while
//! scanning event entries.

use super::EventsParser;
use crate::parser::{
    ast::Section, errors::ParseIssue, position_tracker::PositionTracker,
    sections::SectionParseResult, ParseResult,
};
use alloc::vec::Vec;
